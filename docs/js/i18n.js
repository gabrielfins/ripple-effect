const translations = {
  pt: {
    ...
    'howToUse.intro': 'Use o atributo abaixo para aplicar o efeito:',
    'table.attribute': 'Atributo',
    'table.effect': 'Efeito',
    'table.mdRipplesDesc': 'Aplica o efeito ao elemento',
    'table.ripplesLightDesc': 'Define a cor do efeito para branco (padrão)',
    'table.ripplesDarkDesc': 'Define a cor do efeito para preto',
    'howToUse.usageTitle': 'Uso',
    'howToUse.usageExampleDefault': '&lt;button data-ripples&gt;Teste aqui&lt;/button&gt;',
    'howToUse.usageExampleLight': '&lt;button data-ripples="light"&gt;Teste aqui&lt;/button&gt;',
    'howToUse.usageExampleDark': '&lt;button data-ripples="dark"&gt;Teste aqui&lt;/button&gt;',
    'howToUse.changeDefaultsTitle': 'Mudando os padrões',
    'howToUse.changeDefaultsBody': 'Selecione a classe <code class="code-snippet">.ripple</code> dentro de um elemento com o atributo <code class="code-snippet">data-ripples</code>. Todos os elementos com esse atributo terão esse estilo.',
    'howToUse.opacityIntro': 'Para deixar o efeito mais forte ou fraco, mude a opacidade:',
    'howToUse.opacityDefault': 'A opacidade padrão é <code class="code-snippet">0.16</code>.',
    'howToUse.durationIntro': 'Para deixar o efeito mais rápido ou devagar, mude a duração da animação:',
    'howToUse.durationDefault': 'A duração padrão é <code class="code-snippet">0.3s</code>.',
    'howToUse.customClassTitle': 'Classes personalizadas',
    'howToUse.customClassBody': 'Dê um nome à classe personalizada e selecione a classe <code class="code-snippet">.ripple</code> dentro dela.',
    'howToUse.customClassExample': '&lt;button data-ripples class="ripples-purple"&gt;Teste aqui&lt;/button&gt;',
  ...
  en: {
    ...
    'howToUse.intro': 'Use the attribute below to apply the effect:',
    'table.attribute': 'Attribute',
    'table.effect': 'Effect',
    'table.mdRipplesDesc': 'Applies the effect to the element',
    'table.ripplesLightDesc': 'Sets the effect color to white (default)',
    'table.ripplesDarkDesc': 'Sets the effect color to black',
    'howToUse.usageTitle': 'Usage',
    'howToUse.usageExampleDefault': '&lt;button data-ripples&gt;Try it here&lt;/button&gt;',
    'howToUse.usageExampleLight': '&lt;button data-ripples="light"&gt;Try it here&lt;/button&gt;',
    'howToUse.usageExampleDark': '&lt;button data-ripples="dark"&gt;Try it here&lt;/button&gt;',
    'howToUse.changeDefaultsTitle': 'Changing the defaults',
    'howToUse.changeDefaultsBody': 'Select the <code class="code-snippet">.ripple</code> class inside an element with the <code class="code-snippet">data-ripples</code> attribute. Every element with that attribute will have this style.',
    'howToUse.opacityIntro': 'To make the effect stronger or weaker, change the opacity:',
    'howToUse.opacityDefault': 'The default opacity is <code class="code-snippet">0.16</code>.',
    'howToUse.durationIntro': 'To make the effect faster or slower, change the animation duration:',
    'howToUse.durationDefault': 'The default duration is <code class="code-snippet">0.3s</code>.',
    ...
    'howToUse.customClassExample': '&lt;button data-ripples class="ripples-purple"&gt;Try it here&lt;/button&gt;',
    'download.title': 'Download',
